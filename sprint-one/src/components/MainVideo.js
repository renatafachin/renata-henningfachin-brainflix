            ...
            <div className="video__details">
                <div>
                    ...
                    <div className="video__details-author-date">
                        <h2>By Red Cow</h2>
                        <h2 className="video__details-author-date__date">12/18/2018</h2>
                    </div>
                </div>
                <div className="video__details__views-likes">
                    <img className="video__details-icon" src={viewIcon} alt="Views" />
                    <h4 className="video__details-nums">1,001,023</h4>
                    <img className="video__details-icon" src={likeIcon} alt="Likes" />
                    <h4 className="video__details-nums">110,985</h4>
                </div>
                <hr className="video__divider"></hr>
                <span>
                    <h4 className="video__details-description">
